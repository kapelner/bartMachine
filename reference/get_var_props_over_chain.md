...
- type:
  ...
  a splitting rule versus all splitting rules is computed. If “trees”,
  then the proportion of times each variable appears in a tree versus
  all appearances of variables in trees is computed.
...
[`get_var_counts_over_chain`](https://kapelner.github.io/bartMachine/reference/get_var_counts_over_chain.md)
