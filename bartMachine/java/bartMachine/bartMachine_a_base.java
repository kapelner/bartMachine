...
public abstract class bartMachine_a_base extends Classifier implements Serializable {
	...
	/** Gibbs samples for burn-in and post burn-in of the random intercept variances */
	protected double[] gibbs_samples_of_tausq;
	/** Gibbs samples for post burn-in of the random intercept variances */
	protected double[] gibbs_samples_of_tausq_after_burn_in;
