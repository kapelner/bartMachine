...
The Pseudo-$R^2$ being lower out-of-sample versus in-sample suggests evidence that \pkg{bartMachine} is slightly overfitting (note also that the training sample during cross-validation is 10\% smaller).
